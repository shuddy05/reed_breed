...
const workItems = [
  ...
  { id: 5, src: "/office.jpeg", alt: "Digital Strategy" },
  { id: 6, src: "/office2.jpeg", alt: "Systems Architecture" },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 mb-20 max-w-4xl mx-auto">
          {workItems.map((item, index) => (
            <motion.div
              ...
              className="relative aspect-[1/1.2] rounded-3xl overflow-hidden group bg-surface shadow-2xl cursor-none"
            >
              <Image
                src={item.src}
                alt={item.alt}
